...
def create_files(args):
    ...
    if not os.path.exists('checkpoints/'+args.adapt_mode+'/'+args.dataset+'/'+args.backbone+'/P'+str(args.source_parti)):
        os.makedirs('checkpoints/'+args.adapt_mode+'/'+args.dataset+'/'+args.backbone+'/P'+str(args.source_parti))
...
class EarlyStopping:
    def __init__(self, patience=5, min_delta=0, path='/0.5_best_model.pth'):
